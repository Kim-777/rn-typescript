...
const PersonSequence: FC<PersonProps> = ({person, deletePressed}) => {
  ...
  const animations = useMemo(() => animValues.map((animValue) => Animated.timing(animValue, {useNativeDriver: true, toValue: !started ?  1: 0, duration: 700, easing: Easing.bounce})), [started])
